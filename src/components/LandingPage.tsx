        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
            {dashboardPreviews.map((dashboard, index) => (
              ...
              >
                <div className="flex flex-col items-center justify-between bg-white shadow-lg rounded-2xl p-6 min-h-[320px] transition-transform duration-300 hover:scale-105 hover:shadow-xl h-full">
                  <div className="text-5xl mb-4">{dashboard.emoji}</div>
                  <h2 className="text-xl font-bold text-center">{dashboard.subtitle}</h2>
                  <p className="text-gray-600 text-center mt-2 text-sm sm:text-base">
                    {dashboard.description}
                  </p>
                  <Link
                    to={dashboard.path}
                    className={`mt-6 bg-gradient-to-r ${dashboard.bgGradient} hover:from-${dashboard.color}-600 hover:to-${dashboard.color}-800 text-white font-semibold py-2 px-6 rounded-xl w-full transition-transform hover:scale-105 flex items-center justify-center space-x-2`}
                  >
                    <span>👉</span>
